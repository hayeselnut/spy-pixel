...
\begin{figure}[H]
    \centering
    \subfloat[\centering Email's HTML with inline styling]{{\includegraphics[width=0.5\textwidth]{images/htmlinspectedemail.png} }}
    \qquad
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Glue embeds a spy pixel at the top styling]{{\includegraphics[width=0.4\textwidth]{images/glue_top.png} }}
    \qquad
